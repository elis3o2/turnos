...
CREATE TABLE plantilla_meta(
    ...
    contenido TEXT NOT NULL,
    id_tipo INT NOT NULL,
    pac_nombre BOOLEAN NOT NULL,
    pac_apellido BOOLEAN NOT NULL,
    fecha BOOLEAN NOT NULL,
    horaturno BOOLEAN NOT NULL,
    prof_nombre BOOLEAN NOT NULL,
    prof_apellido BOOLEAN NOT NULL,
    especialidad BOOLEAN NOT NULL,
    efector BOOLEAN NOT NULL,
    servicio BOOLEAN NOT NULL,
    calle BOOLEAN NOT NULL,
    altura BOOLEAN NOT NULL,
    letra BOOLEAN NOT NULL,
    coordx BOOLEAN NOT NULL,
    coordy BOOLEAN NOT NULL,
    tel_efe BOOLEAN NOT NULL,
    calle_nom BOOLEAN NOT NULL,
...
ADD COLUMN pac_apellido BOOLEAN DEFAULT(FALSE),
ADD COLUMN fecha BOOLEAN DEFAULT(FALSE),
ADD COLUMN hora BOOLEAN DEFAULT(FALSE),
ADD COLUMN horaturno BOOLEAN DEFAULT(FALSE),
ADD COLUMN prof_nombre BOOLEAN DEFAULT(FALSE),
ADD COLUMN prof_apellido BOOLEAN DEFAULT(FALSE),
ADD COLUMN especialidad BOOLEAN DEFAULT(FALSE),
ADD COLUMN efector BOOLEAN DEFAULT(FALSE),
ADD COLUMN servicio BOOLEAN DEFAULT(FALSE),
ADD COLUMN calle BOOLEAN DEFAULT(FALSE),
ADD COLUMN altura BOOLEAN DEFAULT(FALSE),
ADD COLUMN letra BOOLEAN DEFAULT(FALSE),
ADD COLUMN coordx BOOLEAN DEFAULT(FALSE),
ADD COLUMN coordy BOOLEAN DEFAULT(FALSE),
ADD COLUMN tel_efe BOOLEAN DEFAULT(FALSE),
ADD COLUMN calle_nom BOOLEAN DEFAULT(FALSE),
ADD COLUMN url VARCHAR(128) NULL